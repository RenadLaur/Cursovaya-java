...
2. Найти класс `RestaurantApplication` (`kz.enu.restaurant.RestaurantApplication`).

3. Нажать **Run** (зелёный треугольник).

4. Убедиться, что в логах есть строка вроде:
...
2. Открыть папку `frontend/` в проводнике.
3. Дважды щёлкнуть по `index.html`, чтобы открыть его в браузере.
...
<img width="1228" height="942" alt="image" src="https://github.com/user-attachments/assets/ffed6250-15a8-4d26-9207-616c1dca63a5" />
